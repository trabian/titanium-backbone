...
(function(/*! Stitch !*/) {
  ...
  module.exports = {
    run: function() {
      return this.createWindow('basic_with_child_views');
    },
    createWindow: function(name) {
      var Window, window;
      Window = require("views/windows/" + name);
      window = new Window;
      return window.render().el.open();
    }
  };
...
}, "views/windows/basic_with_child_views": function(exports, require, module) {(function() {
  var $, View, Window,
    __hasProp = Object.prototype.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor; child.__super__ = parent.prototype; return child; };
  ...
  module.exports = Window = (function(_super) {
    ...
    Window.prototype.render = function() {
      $('<Button>').attr('title', 'Testing').appendTo(this.$el);
      return this;
    };
  ...
  module.exports = function(ti) {
    ...
    $ = function(element) {
      ...
      if (element instanceof ElementCollection) {
        ...
        if (match = element.match(/^\<(\w*)\s?\/?\>$/)) {
          return $(ti.createView(match[1]));
        }
      } else {
